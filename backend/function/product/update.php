...
<div class="container mt-5">
    ...
    $sql = "SELECT id, name, price,description, stock_quantity, image_url FROM products WHERE id = $id";
    ...
    <form action="updateprocess.php" method="POST" class="bg-white p-4 rounded shadow-sm">
